...
//voy a ir listando lo necesario para trabajar en este script:  especifico conexion y tabla
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Listado de Prioridades Registradas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php for ($i=0; $i<$CantidadPrioridades; $i++) { ?>
                                            <tr>
                                            <td><?php echo $ListadoPrioridades[$i]['ID']; ?></td>
                                            <td><?php echo $ListadoPrioridades[$i]['NOMBRE']; ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
