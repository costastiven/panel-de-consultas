...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Listado de Categorias Registrados</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php for ($i=0; $i<$CantidadCategorias; $i++) { ?>
                                            <tr>
                                            <td><?php echo $ListadoCategorias[$i]['ID']; ?></td>
                                            <td><?php echo $ListadoCategorias[$i]['NOMBRE']; ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
